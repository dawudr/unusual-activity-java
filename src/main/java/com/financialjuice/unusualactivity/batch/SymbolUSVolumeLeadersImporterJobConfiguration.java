...
public class SymbolUSVolumeLeadersImporterJobConfiguration {

    private static final Logger log = LoggerFactory.getLogger(SymbolUSVolumeLeadersImporterJobConfiguration.class);
    ...
    public SymbolUSVolumeLeadersImporterJobConfiguration() {
    ...
    public ItemReader<SymbolData> reader() {
        ...
        reader.setLineMapper(new DefaultLineMapper<SymbolData>() {{
            setLineTokenizer(new SymbolUSVolumeLeadersDelimitedLineTokenizer());
            setFieldSetMapper(new SymbolUSVolumeLeadersFieldSetMapper());
        }});
        return reader;
    }
...
//        writer.setEntityManagerFactory(entityManagerFactory().getObject());
    ...
    public Job job_SymbolImporter() {
        ...
        return jobBuilderFactory.get("job_SymbolUSVolumeLeadersImporter")
