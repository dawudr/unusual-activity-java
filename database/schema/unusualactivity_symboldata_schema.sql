...
--
-- Table structure for table `symboldata`
--

DROP TABLE IF EXISTS `symboldata`;
...
CREATE TABLE `symboldata` (
  ...
  `fcacategory` varchar(255) DEFAULT NULL,
  `industry` varchar(255) DEFAULT NULL,
  `instrumentname` varchar(255) DEFAULT NULL,
  `market` varchar(255) DEFAULT NULL,
  `marketcap` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2018-04-25 17:23:06
